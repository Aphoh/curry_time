defmodule CurryTime.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, CurryTime.Repo)
  ...
  defp validate_password(changeset) do
    ...
    |> validate_length(:password, min: if(Mix.env() == :dev, do: 1, else: 12), max: 80)
  ...
  """
  def valid_password?(%CurryTime.Accounts.User{hashed_password: hashed_password}, password)
