defmodule CurryTimeWeb.UserAuthTest do
  use CurryTimeWeb.ConnCase, async: true

  alias CurryTime.Accounts
  alias CurryTimeWeb.UserAuth
  import CurryTime.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CurryTimeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      Phoenix.PubSub.subscribe(CurryTime.PubSub, live_socket_id)
